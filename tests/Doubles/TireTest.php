...
class TireTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $tireMakerDummy = $this->getMock('\Examples\Doubles\TireMaker');
        
        $tireStub = $this->getMockBuilder('\Examples\Doubles\Tire')
    ...
    public function testWhenMockingByUsingMockeryAsAHelperThenProtectedMethodsCanBeFaked()
    {
        ...
        $tireStub = \Mockery::mock('\Examples\Doubles\Tire')->makePartial();
...
class TireUnderTest extends Tire
{
    public function __construct($tirePressure = 2, TireMaker $tireMaker = null)
    {
