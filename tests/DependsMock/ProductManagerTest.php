...
use Examples\DependsMock\Products;
use Examples\DependsMock\ProductsManager;
use Examples\DependsMock\ProductFactory;
use Examples\DependsMock\Storage;
...
class ProductManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $mockStorage = $this->getMockBuilder('\Examples\DependsMock\Storage')
