...
class CoreAbstract_setConfig2 extends \PHPUnit_Framework_TestCase
{
	/**
	...
	{
		$emptyArray = array();
		$example = new Example_underTest_setConfig2();
...
class Example_underTest_setConfig2 extends \core\CoreAbstract
{
